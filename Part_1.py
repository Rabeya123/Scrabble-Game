...
# To create a dictionary with each letter from the sequence and it's frequency
...
# To display the dictionary hand as a user friendly string of characters
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    if(word!='.'):
        print("Run out of letters. Total score:", total)
